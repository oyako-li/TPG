...
class Trainer2:
    def __init__(self, 
        ...
        # configure tpg functions and variable appropriately now
        configurer.configure2(self, Trainer2, Agent2, Team2, Learner2, ActionObject2, Program2, self.memType is not None, self.memType, self.doReal, self.operationSet, self.traversal)
    ...
    def resetActions(self, actions):
        ...
        if self.doReal: self.nActRegisters = max(max(self.actionLengths), self.nActRegisters)
        self.nActRegisters = self.nActRegisters
        configurer.configure2(self, Trainer2, Agent2, Team2, Learner2, ActionObject2, Program2, 
            self.memType is not None, self.memType, self.doReal, self.operationSet, self.traversal)
    ...
    def cleanup(self):
        configurer._configureDefaults2(self, Trainer2, Agent2, Team2, Learner2, ActionObject2, Program2)
